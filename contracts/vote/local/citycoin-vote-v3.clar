...
(define-read-only (get-mia-vote (user principal) (scaled bool))
  (let
    (
      ...
      ;; MIA cycle 24 / first block 74,897, cycle 2 / u4500 used in tests
      ;; mainnet: 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-core-v2
      (cycle24Hash (unwrap! (get-block-hash u4500) none))
      (cycle24Data (at-block cycle24Hash (contract-call? .citycoin-core-v1 get-stacker-at-cycle-or-default u2 userId)))
      (cycle24Amount (get amountStacked cycle24Data))
      ;; MIA cycle 25 / first block 76,997, cycle 3 / u6600 used in tests
      ;; mainnet: 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-core-v2
      (cycle25Hash (unwrap! (get-block-hash u6600) none))
      (cycle25Data (at-block cycle25Hash (contract-call? .citycoin-core-v1 get-stacker-at-cycle-or-default u3 userId)))
...
(define-read-only (get-nyc-vote (user principal) (scaled bool))
  (let
    (
      (userId (default-to u0 (contract-call? .citycoin-core-v1 get-user-id user)))
      ;; NYC cycle 18 / first block 75,249, cycle 2 / u4500 used in tests
      ;; mainnet: 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-core-v2
      (cycle18Hash (unwrap! (get-block-hash u4500) none))
      (cycle18Data (at-block cycle18Hash (contract-call? .citycoin-core-v1 get-stacker-at-cycle-or-default u2 userId)))
      (cycle18Amount (get amountStacked cycle18Data))
      ;; NYC cycle 19 / first block 77,349, cycle 3 / u6600 used in tests
      ;; mainnet: 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-core-v2
      (cycle19Hash (unwrap! (get-block-hash u6600) none))
      (cycle19Data (at-block cycle19Hash (contract-call? .citycoin-core-v1 get-stacker-at-cycle-or-default u3 userId)))
